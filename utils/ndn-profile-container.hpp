...
class MobilityProfileContainer : public SimpleRefCount<MobilityProfileContainer> {
private:
  typedef std::vector<shared_ptr<MobilityProfile>> Container;
...
public:
   ...
   */
  MobilityProfileContainer(const MobilityProfileContainer& other);
   ...
   */
  MobilityProfileContainer&
  operator=(const MobilityProfileContainer& other);
   ...
   */
  void
  Add(shared_ptr<MobilityProfile> face);
   ...
   */
  void
  AddAll(Ptr<MobilityProfileContainer> other);
   ...
   */
  void
  AddAll(const MobilityProfileContainer& other);
