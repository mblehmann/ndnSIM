...
#ifndef PDRM_MOBILE_TRACER_H
#define PDRM_MOBILE_TRACER_H
 ...
 */
class PDRMMobileTracer : public SimpleRefCount<PDRMMobileTracer> {
public:
  /**
   ...
   */
  PDRMMobileTracer(shared_ptr<std::ostream> os, Ptr<Node> node);
   ...
   */
  PDRMMobileTracer(shared_ptr<std::ostream> os, const std::string& node);
