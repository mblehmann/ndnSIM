...
#ifndef PDRM_CONSUMER_STREAMING_H
#define PDRM_CONSUMER_STREAMING_H
 ...
 */
class PDRMConsumerStreaming : public PDRMConsumer {
public:
  static TypeId
  GetTypeId();

  // Constructor
  PDRMConsumerStreaming();
  virtual ~PDRMConsumerStreaming(){};
...
#endif // PDRM_CONSUMER_STREAMING_H
